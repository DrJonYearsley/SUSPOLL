...
CalculateAverages = function(MeraData,LookupTable,Location,mode){
  ...
  Avg_SD[1,1] = mean(Subset0$Value.)      #column for mean/sd
  Avg_SD[2,1] = mean(Subset300$Value.)   #column for 
  Avg_SD[3,1] = mean(Subset600$Value.)   #column for 
  Avg_SD[4,1] = mean(Subset900$Value.)   #column for 
  Avg_SD[5,1] = mean(Subset1200$Value.)   #column for 
  Avg_SD[6,1] = mean(Subset1500$Value.)   #column for 
  Avg_SD[7,1] = mean(Subset1800$Value.)   #column for 
  Avg_SD[8,1] = mean(Subset2100$Value.)   #column for 
...
Find_Heatwaves = function(MeraData,LookupTable,mode){
...
# ThoraxTemps_MinAvgMax_1 = CalculateAverages(MeraData1,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_2 = CalculateAverages(MeraData2,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_3 = CalculateAverages(MeraData3,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_4 = CalculateAverages(MeraData4,LookupTable,c(53.457,-6.140),3)
ThoraxTemps_MinAvgMax_5 = CalculateAverages(MeraData5,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_6 = CalculateAverages(MeraData6,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_7 = CalculateAverages(MeraData7,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_8 = CalculateAverages(MeraData8,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_9 = CalculateAverages(MeraData9,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_10 = CalculateAverages(MeraData10,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_11 = CalculateAverages(MeraData11,LookupTable,c(53.457,-6.140),3)
# ThoraxTemps_MinAvgMax_12 = CalculateAverages(MeraData12,LookupTable,c(53.457,-6.140),3)
...
Heatwave_Averages = Find_Heatwaves(MeraDataGrand,LookupTable,3)
...
y=ThoraxTemps_MinAvgMax_5[,2]
y_plus = ThoraxTemps_MinAvgMax_5[,3]
y_minus = ThoraxTemps_MinAvgMax_5[,1]
#points(x, y,col=rainbow(12)[5])
plot(x[hours], y[hours], ylim=y_range,col=rainbow(12)[5],xlab='time',ylab='temperature (C)', main='2016 May Average')
...
points(x[hours],ThoraxTemps_MinAvgMax_5[hours,5])      #add the air temperature
y_plus_air = ThoraxTemps_MinAvgMax_5[,6]
y_minus_air = ThoraxTemps_MinAvgMax_5[,4]
...
y=Heatwave_Averages[,2]
y_plus = Heatwave_Averages[,3]
y_minus = Heatwave_Averages[,1]
#points(x, y, ylim=c(38,43),col=rainbow(12)[1])
plot(x[hours], y[hours], ylim=y_range,col=1,xlab='time (hours)',ylab='temperature (C)', main='2016 Heatwave Day Average')
...
points(x[hours],Heatwave_Averages[hours,5],col='blue')      #add the air temperature
y_plus_air = Heatwave_Averages[,6]
y_minus_air = Heatwave_Averages[,4]
