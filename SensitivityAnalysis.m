...
if Honeybee==true
    if indicator==3
        writematrix(Thorax_Equilibria_Variability,'Thorax_Equilibria_Variability_flying_combined_10000_HB.csv');
    end
    if indicator==2
        writematrix(Thorax_Equilibria_Variability,'Thorax_Equilibria_Variability_shivering_combined_10000_HB.csv');
    end
    if indicator==1
        writematrix(Thorax_Equilibria_Variability,'Thorax_Equilibria_Variability_resting_combined_10000_HB.csv');
    end
end

if Bumblebee==true
    if indicator==3
        writematrix(Thorax_Equilibria_Variability,'Thorax_Equilibria_Variability_flying_combined_10000_BB.csv');
    end
    if indicator==2
        writematrix(Thorax_Equilibria_Variability,'Thorax_Equilibria_Variability_shivering_combined_10000_BB.csv');
    end
    if indicator==1
        writematrix(Thorax_Equilibria_Variability,'Thorax_Equilibria_Variability_resting_combined_10000_BB.csv');
    end
end
