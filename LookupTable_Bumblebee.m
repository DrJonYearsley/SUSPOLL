...
M_b = 0.351;   %mass of the bee in g, Joos1991, maximum
...
f_s = 0.9;  %fraction of internal temp at surface
...
writematrix(Temps,'LookupTable_Bumblebee_Opt1.csv');
...
plot(air,Temps_median(:,4),'b-.')  %active, resting
