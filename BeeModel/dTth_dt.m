...
% Thorax metabolic heat gain (anonymous function)  Checked
...
% Heat gain from longwave radiation (i.e. atmosphere)   Checked
...
% Radiative heat loss Checked
Q_R = @(T, P) P.epsilon_e * P.A_th * P.sigma * T^4;

% Conductive heat loss Checked
...
param_H = params;
% Update surface area and diameter for the head
param_H.A_th = params.A_h;
%param_H.d_th = params.d_h;
param_H.s = 1;  
