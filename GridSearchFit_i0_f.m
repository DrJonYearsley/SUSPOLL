...
i0_max = 0.15;  %Kammer number

s_min = 0.7;
s_max = 1;

i0_axis = [i0_min:0.0005:i0_max];
s_axis = [s_min:0.001:s_max];
...
%tocBytes(gcp);
%toc
writematrix(ShiverTo30,'ShiverTo30_i0_s_1.csv');
writematrix(Diverge,'Diverge_i0_s_1.csv');
writematrix(ThermalDanger,'ThermalDanger_i0_s_1.csv');
