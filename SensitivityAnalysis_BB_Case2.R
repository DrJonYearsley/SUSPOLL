...
Equilibria_resting = read.csv(file="BB_Thorax_Equilibria_Variability_resting_case2_10000.csv",header=FALSE)
Equilibria_shivering = read.csv(file="BB_Thorax_Equilibria_Variability_shivering_case2_10000.csv",header=FALSE)
Equilibria_flying = read.csv(file="BB_Thorax_Equilibria_Variability_flying_case2_10000.csv",header=FALSE)
...
write.csv(resting_contributions,file="case2_contributions_resting.csv")
write.csv(shivering_contributions,file="case2_contributions_shivering.csv")
write.csv(flying_contributions,file="case2_contributions_flying.csv")

resting_R2
shivering_R2
flying_R2

write.csv(c(resting_R2,shivering_R2,flying_R2),file="case2_R2_values.csv")
...
write.csv(Influences_resting_1000,file="case2_Influences_resting_1000.csv")
write.csv(Influences_shivering_1000,file="case2_Influences_shivering_1000.csv")
write.csv(Influences_flying_1000,file="case2_Influences_flying_1000.csv")
...
write.csv(Influences_resting_2500,file="case2_Influences_resting_2500.csv")
write.csv(Influences_shivering_2500,file="case2_Influences_shivering_2500.csv")
write.csv(Influences_flying_2500,file="case2_Influences_flying_2500.csv")
...
write.csv(Influences_resting_5000,file="case2_Influences_resting_5000.csv")
write.csv(Influences_shivering_5000,file="case2_Influences_shivering_5000.csv")
write.csv(Influences_flying_5000,file="case2_Influences_flying_5000.csv")
...
write.csv(Influences_resting_7500,file="case2_Influences_resting_7500.csv")
write.csv(Influences_shivering_7500,file="case2_Influences_shivering_7500.csv")
write.csv(Influences_flying_7500,file="case2_Influences_flying_7500.csv")
...
write.csv(Influences_resting_10000,file="case2_Influences_resting_10000.csv")
write.csv(Influences_shivering_10000,file="case2_Influences_shivering_10000.csv")
write.csv(Influences_flying_10000,file="case2_Influences_flying_10000.csv")
...
par(mfrow=c(3,1))
plot(D_resting,main="Resting Bee Case 2",type='b')
plot(D_shivering, main="Shivering Bee Case 2",type='b')
plot(D_flying, main="Flying Bee Case 2",type='b')

write.csv(cbind(D_resting,D_shivering,D_flying),file="case2_D_values.csv")
